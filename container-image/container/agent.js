...
import { encode, makeHello, makeHeartbeat, makeNudgeAck, makeWebFetch, MessageReader, } from "../shared/protocol.js";
...
function handleSocket(sock, cleanup) {
    ...
    function handleMessage(s, msg) {
        switch (msg.type) {
            ...
            case "web_fetch_response":
                log("got web_fetch response", { bytes: msg.payload?.bytes });
                break;
            default:
